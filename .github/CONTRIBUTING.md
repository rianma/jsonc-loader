...
{
  "devDependencies": {
    "jsonc-loader": "null/jsonc-loader#{id}/head"
  }
}
```
...
When submitting your contribution, a CLA (Contributor License Agreement) bot will come by to verify that you signed the [CLA](https://cla.js.foundation/null/jsonc-loader).
